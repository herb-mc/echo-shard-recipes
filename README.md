...
| Energized      | Enchanted Golden Apple | Utility   | Armor               | Increases mana regen rate - a full set provides an additional boost                                                            |
...
| Grappling      | Fishing Rod            | Mobility  | Fishing Rod         | Hook latches onto blocks and pulls the user when reeled                                                                        |
| Levitator      | Shulker Shell          | Mobility  | Boots               | While crouching: gain levitation                                                                                               |
| Machine Assist | Piston                 | Mobility  | Legs                | Jump Boost I, or II while crouching - stacks with other status effect gear                                                     |
...
**Base recipe**: spell focus + stick + spell ingredient

| Spell      | Ingredient    | Description                                                                                          | Mana Cost | Cooldown |
|------------|---------------|------------------------------------------------------------------------------------------------------|-----------|----------|
